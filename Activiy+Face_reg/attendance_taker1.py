...
class Face_Recognizer:
                ...
                # 6.2  If cnt of faces changes, 0->1 or 1->0 or ...
                    ...
                    # 6.2.2 / Face cnt increase: 0->1, 0->2, ..., 1->2, ...
                        ...
                        for k in range(len(faces)):
                            ...
                            dist = "%.2f" % min(self.current_frame_face_X_e_distance_list)
                            ...
                            if min(self.current_frame_face_X_e_distance_list) < 0.4:
                                ...
                                print("Name: %s, Min: %s" %(nam,min((self.current_frame_face_X_e_distance_list))))
                                if (index <= 40):
                                    hung.append(nam)
                                    prob_hung.append(dist)
                                else:
                                    huy.append(nam)
                                    prob_huy.append(dist)
                                #self.attendance(nam)
                            else:
                                print("Name: %s, Min: %s" %("unknown",min((self.current_frame_face_X_e_distance_list))))
    ...
    def run(self):
        global hung,huy,prob_hung,prob_huy
        global name_check
        name_check = "Megan Fox"
        trained_path = 'D:/Anaconda/Face-Recognition-Based-Attendance-System/test_dataset/pack4/person (10)'
        none_path = 'D:/Anaconda/Face-Recognition-Based-Attendance-System/test_dataset/pack4/none'
        Sep_path = []
        noneSep_path = []
        ...
        # for name, prob in zip(hung, prob_hung):
        #     print(f"{name} {prob}")

        for name in hung:
            print(name)
        
        for name in prob_hung:
            print(name)
        
        for name in huy:
            print(name)
        
        for name in prob_huy:
            print(name)
